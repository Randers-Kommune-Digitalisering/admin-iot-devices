const Node = {
  ...
  "rules": [
    ...
    },
    {
      ...
      "p": "template.values",
      "pt": "msg",
      "to": "[\t    {\t        \"col\": 0,\t        \"type\": \"artskode\",\t        \"description\": \"Målepunkts art for værdiserie 1 (valgfrit)\",\t        \"note\": \"Benyttes til målepunktsnøgle for værdiserie 1\",\t        \t        \"valueHeader\":\t        {\t            \"obj\": \"@maalepunkt\",\t            \"key\": \"artskode\"\t        },\t        \"valueBody\":\t        {\t            \"obj\": \"@maalepunkt\",\t            \"key\": \"artskode\"\t        }\t    },\t    {\t        \"col\": 1,\t        \"type\": \"tekst\",\t        \"description\": \"Målepunkts navn for værdiserie 1 (valgfrit)\",\t        \"note\": \"Benyttes som navn for målepunkt ved oprettelse. Hvis ikke angivet benyttes standard navn for værdiserie 1.\",\t\t        \"valueHeader\":\t        {\t            \"obj\": \"@maalepunkt\",\t            \"key\": \"title\"\t        },\t        \"valueBody\":\t        {\t            \"obj\": \"@data\",\t            \"key\": \"@key\"\t        }\t    },    \t    {\t        \"col\": 2,\t        \"type\": \"typekode\",\t        \"description\": \"Målepunkts type for værdiserie 1 (valgfrit)\",\t        \"note\": \"Benyttes som type for målepunkt ved oprettelse. Hvis ikke angivet sættes type ud fra enhed for første modtaget værdi for værdiserie 1.\",\t        \t        \"valueHeader\":\t        {\t            \"obj\": \"@maalepunkt\",\t            \"key\": \"typekode\"\t        },\t        \"valueBody\":\t        {\t            \"obj\": \"@maalepunkt\",\t            \"key\": \"type\"\t        }\t    }\t]",
      "tot": "jsonata"
    },
    {
      "t": "set",
